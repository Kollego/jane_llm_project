...
class RAGNirChecker(BaseRAGChecker):
    """
    Класс-проверщик НИР (Научно-исследовательской работы), основанный на базовом RAG.
    ...
    def build_prompt(
        ...
        human_template = (
            "ЗАДАНИЕ:\n---\n{assignment}\n---\n\n"
            "НИР (научно-исследовательская работа) СТУДЕНТА:\n---\n{nir}\n---\n\n"
            "НАЙДЕННЫЕ ИСТОЧНИКИ:\n---\n{context}\n---\n\n"
            "Проанализируй НИР и дай обратную связь.\n\n"
